...
def inference(split, epoch):
    cfgs.dump_dir = '/media/ama/data0/gz/graspnet/graspness_unofficial/logs/' + model_type + '/' + 'dump_epoch' + str(epoch).zfill(2) + '_add_language_frozen_with_rgb'
...
def evaluate(split, epoch, TOP_K=1,re=''):
    dump_dir = '/media/ama/data0/gz/graspnet/graspness_unofficial/logs/' + model_type + '/' + re +  'dump_epoch_' + str(
        epoch).zfill(2)  + '_with_cliport' + '/SORTED'
    ...
    #                                                                 return_cls_acc=return_cls_acc,
    #                                                                 use_origin=use_origin, proc=6)
    cfgs.dump_dir = '/media/ama/data0/gz/graspnet/graspness_unofficial/logs/' + model_type + '/' + re + 'dump_epoch_' + str(
        epoch).zfill(2) + '_with_cliport'
...
if __name__ == '__main__':
    ...
    #務必將graspnet_eval_add_language_frozen中的encoder split對應作修改
    evaluate('test_seen', 10)
    # evaluate('test_similar', 10, re='real_')
