...
parser.add_argument('--checkpoint_path', help='Model checkpoint path', default='/media/ama/data0/gz/graspnet/graspness_unofficial/WEIGHT/np15000_graspness1e-1_bs4_lr1e-3_viewres_dataaug_fps_14D_epoch10.tar', required=False)
# parser.add_argument('--dump_dir', help='Dump dir to save outputs', default='logs/log_kn/dump_epoch10_debug_test_time', required=False)
parser.add_argument('--dump_dir', help='Dump dir to save outputs', default='/media/ama/data0/gz/graspnet/graspness_unofficial/logs/log_kn/dump_epoch10', required=False)
parser.add_argument('--seed_feat_dim', default=512, type=int, help='Point wise feature dim')
parser.add_argument('--camera', default='kinect', help='Camera split [realsense/kinect]')
parser.add_argument('--num_point', type=int, default=15000, help='Point Number [default: 15000]')
parser.add_argument('--batch_size', type=int, default=32, help='Batch Size during inference [default: 1]')
...
def evaluate(dump_dir):
    ...
    save_dir = os.path.join(cfgs.dump_dir, 'ap_{}.txt'.format(cfgs.camera))
    # np.savetxt(save_dir, ap)
