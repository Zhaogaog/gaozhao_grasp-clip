...
parser.add_argument('--checkpoint_path', help='Model checkpoint path', default='/media/ama/data0/gz/graspnet/graspness_unofficial/logs/log_kn/CHECKPOINT/minkuresunet_add_language_frozen_epoch10.tar', required=False)
parser.add_argument('--dump_dir', help='Dump dir to save outputs', default='/media/ama/data0/gz/graspnet/graspness_unofficial/logs/log_kn/dump_epoch15_add_language_frozen', required=False)
