...
from models.GRASPNET.graspnet_add_language_frozen_with_rgb_resnet18_test import GraspNet, pred_decode
from dataset.graspnet_dataset_add_language_frozen_with_rgb import GraspNetDataset, minkowski_collate_fn
...
parser.add_argument('--checkpoint_path', help='Model checkpoint path', default='/media/ama/data0/gz/graspnet/graspness_unofficial/logs/log_kn_with_rgb_resnet18/minkuresunet_add_language_frozen_epoch_with_rgb15.tar', required=False)
parser.add_argument('--dump_dir', help='Dump dir to save outputs', default='/media/ama/data0/gz/graspnet/graspness_unofficial/logs/log_kn_with_rgb_resnet18/dump_epoch15_add_language_frozen_with_rgb', required=False)
...
if __name__ == '__main__':
    ...
    evaluate(cfgs.dump_dir, 'test_evaluate')
    inference('test_train')
    # evaluate(cfgs.dump_dir, 'test_train')
