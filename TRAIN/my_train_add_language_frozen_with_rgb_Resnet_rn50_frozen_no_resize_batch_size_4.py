...
from models.GRASPNET.my_graspnet_add_language_frozen_with_rgb_Resnet_rn50 import GraspNet
...
parser.add_argument('--log_dir', default='/media/ama/data0/gz/graspnet/graspness_unofficial/logs/log_kn_with_rgb_my_Resnet_rn50_frozen_no_resize_batch_size_4')
...
cfgs.checkpoint_path = '/media/ama/data0/gz/graspnet/graspness_unofficial/logs/log_kn_with_rgb_my_Resnet_rn50_frozen_no_resize_batch_size_4/minkuresunet_add_language_frozen_epoch_with_rgb03.tar'
cfgs.resume = True
