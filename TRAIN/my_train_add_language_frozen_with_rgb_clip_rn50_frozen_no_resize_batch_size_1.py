...
parser.add_argument('--log_dir', default='/media/ama/data0/gz/graspnet/graspness_unofficial/logs/log_kn_with_rgb_my_clip_rn50_frozen_no_resize_batch_size_1')
...
parser.add_argument('--max_epoch', type=int, default=40, help='Epoch to run [default: 18]')
...
cfgs.checkpoint_path = '/media/ama/data0/gz/graspnet/graspness_unofficial/logs/log_kn_with_rgb_my_clip_rn50_frozen_no_resize_batch_size_1/minkuresunet_add_language_frozen_epoch_with_rgb20.tar'
cfgs.resume = True
...
net = GraspNet(seed_feat_dim=cfgs.seed_feat_dim, is_training=True, device=device)
