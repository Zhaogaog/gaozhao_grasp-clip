...
from dataset.my_graspnet_dataset_add_language_frozen_with_rgb_no_resize_for_debug import GraspNetDataset, minkowski_collate_fn
...
parser.add_argument('--log_dir', default='/media/ama/data0/gz/graspnet/graspness_unofficial/logs/log_kn_with_rgb_my_clip_rn50_frozen_no_resize_batch_size_4_large_dataset_for_debug')
...
cfgs.checkpoint_path = '/media/ama/data0/gz/graspnet/graspness_unofficial/logs/log_kn_with_rgb_my_clip_rn50_frozen_no_resize_batch_size_4/minkuresunet_add_language_frozen_epoch_with_rgb15.tar'
cfgs.resume = True
...
def train_one_epoch():
    ...
    for batch_idx, batch_data_label in enumerate(tqdm(TRAIN_DATALOADER, desc='Train')):
        ...
        loss, end_points = get_loss(end_points, net, alpha=1 )
        loss.backward()
        optimizer.step()
