...
from models.GRASPNET.my_graspnet_add_language_frozen_with_rgb_clip_rn50_no_more_text import GraspNet
...
parser.add_argument('--log_dir', default='/media/ama/data0/gz/graspnet/graspness_unofficial/logs/log_kn_with_rgb_my_clip_rn50_frozen_no_resize_batch_size_4_no_more_text')
...
# cfgs.checkpoint_path = '/media/ama/data0/gz/graspnet/graspness_unofficial/logs/log_kn_with_rgb_my_clip_rn50_frozen_no_resize_batch_size_4_no_image/minkuresunet_add_language_frozen_epoch_with_rgb13.tar'
cfgs.resume = True
