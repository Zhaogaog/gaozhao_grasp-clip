...
from dataset.my_graspnet_dataset_add_language_frozen_with_rgb_no_resize_smaller_dataset import GraspNetDataset, minkowski_collate_fn
...
parser.add_argument('--log_dir', default='/media/ama/data0/gz/graspnet/graspness_unofficial/logs/log_kn_with_rgb_my_clip_rn50_frozen_no_resize_batch_size_4_smaller_dataset')
...
# cfgs.checkpoint_path = '/media/ama/data0/gz/graspnet/graspness_unofficial/logs/log_kn_with_rgb_my_clip_rn50_frozen_no_resize_batch_size_4_large_dataset/minkuresunet_add_language_frozen_epoch_with_rgb05.tar'
cfgs.resume = True
