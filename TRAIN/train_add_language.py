...
from models.graspnet_add_language import GraspNet
from models.loss_add_language import get_loss
from dataset.graspnet_dataset_add_language import GraspNetDataset, minkowski_collate_fn, load_grasp_labels
...
# ------------------------------------------------------------------------- GLOBAL CONFIG BEG
EPOCH_CNT = 0
cfgs.checkpoint_path = '/home/gaozhao/graspness_unofficial/np15000_graspness1e-1_bs4_lr1e-3_viewres_dataaug_fps_14D_epoch10.tar'
cfgs.resume = True
