...
from models.GRASPNET.graspnet_add_language_frozen_with_rgb_clip_rn50 import GraspNet
...
parser.add_argument('--log_dir', default='/media/ama/data0/gz/graspnet/graspness_unofficial/logs/log_kn_with_rgb_clip_rn50_no_frozen_no_resize')
...
cfgs.checkpoint_path ='/media/ama/data0/gz/graspnet/graspness_unofficial/logs/log_kn_with_rgb_clip_rn50_no_frozen_no_resize/minkuresunet_add_language_frozen_epoch_with_rgb13.tar'
cfgs.resume = True
...
net = GraspNet(seed_feat_dim=cfgs.seed_feat_dim, is_training=True, img_encoder_frozen=False)
...
for (name, param) in net.graspable.named_parameters():
    # if name in checkpoint['model_state_dict']:
    param.requires_grad = False
# params = net.clip.clip_rn50.named_parameters()
# state_dict  = net.state_dict()
for (name, param) in net.clip.clip_rn50.named_parameters():
    param.requires_grad = False
for (name, param) in net.clip.clip_rn50.visual.named_parameters():
...
def train_one_epoch():
    ...
    net.clip.clip_rn50.visual.train()
