...
from models.GRASPNET.my_graspnet_add_language_frozen_with_rgb_Resnet_rn50 import GraspNet, pred_decode, real_pred_decode
...
if __name__ == '__main__':
    ...
    model_type = 'log_kn_with_rgb_my_Resnet_rn50_frozen_no_resize_batch_size_4'
    epoch = 10
    main(split, model_type, epoch)
    epoch_chosen = 'dump_epoch' + str(epoch) + '_add_language_frozen_with_rgb'
    evaluation = my_evaluate(evaluation_root_dir, model_type, epoch_chosen, split)
