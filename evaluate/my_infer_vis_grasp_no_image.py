...
from models.GRASPNET.my_graspnet_add_language_frozen_with_rgb_clip_rn50_no_image import GraspNet, pred_decode, real_pred_decode
...
if __name__ == '__main__':
    ...
    # print(f'{model_type} {epoch_chosen} {split}', evaluation.evaluate_loose())
    split = 'test_similar'
    model_type = 'log_kn_with_rgb_my_clip_rn50_frozen_no_resize_batch_size_4_no_image'
    epoch = 10
    main(split, model_type, epoch)
    epoch_chosen = 'dump_epoch' + str(epoch) + '_add_language_frozen_with_rgb'
    evaluation = my_evaluate(evaluation_root_dir, model_type, epoch_chosen, split)
