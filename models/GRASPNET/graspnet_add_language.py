...
from models.backbone_resunet14 import MinkUNet14D_with_text
...
class GraspNet(nn.Module):
    def __init__(self, cylinder_radius=0.05, seed_feat_dim=512, is_training=True):
        ...
        self.backbone = MinkUNet14D_with_text(in_channels=3, out_channels=self.seed_feature_dim, D=3)
        #抓取点网络
    ...
    def forward(self, end_points):
        ...
        seed_features = self.backbone(mink_input, text_feat).F
