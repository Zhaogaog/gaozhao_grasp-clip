...
from models.modules import ApproachNet, GraspableNet, CloudCrop, SWADNet, Lang_selectNet
...
class GraspNet(nn.Module):
    def __init__(self, cylinder_radius=0.05, seed_feat_dim=512, is_training=True):
        ...
        self.clip_text_encoder = _clip_text_encoder()
        ...
        self.lang_select = Lang_selectNet(seed_feature_dim=self.seed_feature_dim)
    ...
    def forward(self, end_points):
        ...
        end_points['graspable_count_stage1'] = graspable_num_batch / B #平均每个可以被抓起来的点数
        end_points = self.lang_select(seed_features_graspable, text_feat, end_points)
