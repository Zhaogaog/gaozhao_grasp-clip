...
from models.modules_resnet_50 import ApproachNet, GraspableNet, CloudCrop, SWADNet, Lang_selectNet_with_rgb
...
class GraspNet(nn.Module):
    def __init__(self, cylinder_radius=0.05, seed_feat_dim=512, is_training=True, img_encoder_frozen=False):
        super().__init__()
