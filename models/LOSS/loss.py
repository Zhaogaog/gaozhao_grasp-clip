...
def compute_objectness_loss(end_points):
    ...
    # focal_loss = Focal_Loss(weight=torch.tensor([0.98, 0.02], device=objectness_score.device))
    ...
    # src = torch.ones_like(objectness_label).expand(objectness_score.shape[0], objectness_score.shape[1], -1)
    # objectness_label_one_hot.scatter_(1,
    #                                   objectness_label.expand(objectness_score.shape[0], objectness_score.shape[1], -1),
    #                                   src)
